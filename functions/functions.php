...
$db = mysqli_connect("localhost","root","","akima_music");
$count = 0;
...
function add_cart($location_to_redirect = 'details'){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            echo "<script>window.open($location_to_redirect . '.php?pro_id=$p_id','_self' )</script>";

        } else {

          if (!isset($product_qty) || empty($product_qty)) {
            $product_qty = 1;
          }
...
function getPro($location_to_redirect = 'details'){
            ...
            <div class='product'>
                ...
                <div class='text'>
                    ...
                    <p class='button'>
                        ...
                        <a class='btn btn-default' href='$location_to_redirect.php?pro_id=$pro_id'>

                            View Details

                        </a>

                        <a class='btn btn-primary' href='$location_to_redirect.php?add_cart=$pro_id'>
