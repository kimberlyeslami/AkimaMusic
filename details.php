...
<div id="content">
  <div class="container">
    ...
    <?php add_cart(); ?>
          ...
          <form action="cart.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
              <div class="form-group"><!-- form-group Begin -->
                  <label for="" class="col-md-5 control-label">Products Quantity</label>

                  <div class="col-md-7"><!-- col-md-7 Begin -->
                          <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 size for the product')"><!-- form-control Begin --><!-- select Begin -->
              ...
              <button type="submit" class="btn btn-primary i fa fa-shopping-cart"> Add to cart</button>

              <!-- <p class="text-center buttons">
                 <a href="details.php?add_cart=<?php echo $product_id ?>">
                   <i class="btn btn-primary i fa fa-shopping-cart"> Add to cart</i>
                </a>
              </p> -->
